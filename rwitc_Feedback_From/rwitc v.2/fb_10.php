...
if(isset($_GET['last_id'])){
	$action="test10.php?last_id=".$_GET['last_id']."&code=".$code;
} else{
	$action="test10.php";
}
...
{
    if( $('input[name="clean"]:checked').length == 0 )
    {
...
<br><br>
<input type="radio" name="clean" value="Excellent"> Excellent <br>
<input type="radio" name="clean" value="Good"> Good<br>
<input type="radio" name="clean" value="Average"> Average<br>
<input type="radio" name="clean" value="Below Average"> Below Average<br>
<input type="radio" name="clean" value="Poor"> Poor<br>
<input type="radio" name="clean" value="Not applicable"> Not applicable<br>
