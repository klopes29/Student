...
if(isset($_GET['last_id'])){
	$action="test6.php?last_id=".$_GET['last_id']."&code=".$code;
} else{
	$action="test6.php";
}
...
{
    if( $('input[name="booking"]:checked').length == 0 )
    {
...
6.	Booking process
<br><br>
<input type="radio" name="booking" value="Excellent"> Excellent <br>
<input type="radio" name="booking" value="Good"> Good<br>
<input type="radio" name="booking" value="Average"> Average<br>
<input type="radio" name="booking" value="Below Average"> Below Average<br>
<input type="radio" name="booking" value="Poor"> Poor<br>
<input type="radio" name="booking" value="Not applicable"> Not applicable<br>
<br>
