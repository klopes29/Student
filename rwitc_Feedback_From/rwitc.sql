...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2017 at 07:30 AM
...
(1, 1, 'Aaron', 'Fargose', 'Real Image', 'test', '', 'Mumbai', '401203', 99, 1493, '');
...
(1, 'Default', '', 1, '2016-05-08 09:46:52', '2016-05-08 09:46:52');
...
(1, 1, 'NfyHhCstyZGqrLi9HnZ1BBiyZruY298V', '1ap8e7vbeeasaebq5ola4pib43', 'temp_session_57554e011e76d', '127.0.0.1', '2016-06-06 15:48:41', '2016-06-06 15:48:41'),
(2, 1, 'zXEbnFEiSdCnc5UE5JtcaHYKuAA5YlUB', '1ap8e7vbeeasaebq5ola4pib43', 'temp_session_57554e0778030', '127.0.0.1', '2016-06-06 15:48:47', '2016-06-06 15:48:47');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.68699998, 1, '2016-06-08 04:35:41'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-06-09 02:02:34'),
(3, 'Euro', 'EUR', '', '€', '2', 0.87949997, 1, '2016-06-08 04:35:41');
...
(1, 1, 0, 'Aaron', 'Fargose', 'fargose.aaron@gmail.com', '99999999', '', 'c1b3303a94b459c0090c8fbf4ab0cb2b96438c69', 'zD8a0ikNw', NULL, NULL, 1, 1, '', '', 1, 1, 0, '', '', '2016-06-06 21:11:10');
...
(1, 'admin', '::1', 3, '2017-01-18 10:03:37', '2017-01-18 10:04:36');
...
CREATE TABLE `oc_feedback` (
  ...
  `function_held` varchar(64) NOT NULL,
  `function_name` varchar(64) NOT NULL,
  `event_date` date NOT NULL,
  `about_venue` varchar(255) NOT NULL,
  `choice_venue` varchar(255) NOT NULL,
  `staff_courtesy` varchar(255) NOT NULL,
  `booking_process` varchar(32) NOT NULL,
  `change_rooms` varchar(32) NOT NULL,
  `rest_rooms` varchar(32) NOT NULL,
  `lawns` varchar(32) NOT NULL,
  `cleanliness` varchar(32) NOT NULL,
  `billing_process` varchar(32) NOT NULL,
  ...
  `promotional` varchar(10) NOT NULL
...
--
-- Table structure for table `oc_inward`
--
...
--
-- Dumping data for table `oc_inward`
--

INSERT INTO `oc_inward` (`id`, `purchase_order_id`, `product_name`, `product_id`, `manufacturer_name`, `manufacturer_id`, `tdate`, `inc_id`, `quantity`) VALUES
(7, 2, 'iPod Classic', 48, 'Palm', 6, '2016-06-08', 1, 1),
(8, 2, 'test name 2', 37, 'Palm', 6, '2016-06-08', 1, 2),
(9, 2, 'iPod Classic', 48, 'Palm', 6, '2016-06-08', 2, 2),
(10, 2, 'test name 2', 37, 'Palm', 6, '2016-06-08', 2, 1),
(11, 2, 'iPod Classic', 48, 'Palm', 6, '2016-06-08', 3, 1),
(12, 2, 'test name 2', 37, 'Palm', 6, '2016-06-08', 3, 2),
(13, 2, 'iPod Classic', 48, 'Palm', 6, '2016-06-08', 4, 1),
(14, 2, 'test name 2', 37, 'Palm', 6, '2016-06-08', 4, 1),
(15, 2, 'iPod Classic', 48, 'Palm', 6, '2016-06-09', 5, 5),
(16, 2, 'test name 2', 37, 'Palm', 6, '2016-06-09', 5, 1),
(17, 4, 'iMac', 41, 'Apple', 8, '2016-06-11', 6, 50),
(18, 4, 'iMac', 41, 'Apple', 8, '2016-06-11', 7, 50);
...
--
-- Table structure for table `oc_outward`
--

CREATE TABLE `oc_outward` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc_outward`
--

INSERT INTO `oc_outward` (`id`, `invoice_id`, `product_id`, `product_name`, `manufacturer_id`, `manufacturer_name`, `customer_id`, `customer_name`, `price`, `quantity`, `total`, `odate`) VALUES
(1, 1, 41, 'iMac', 8, 'Apple', 1, 'Aaron Fargose', '100.00', 2, '200.00', '2016-06-09'),
(2, 1, 40, 'iPhone', 8, 'Apple', 1, 'Aaron Fargose', '101.00', 3, '303.00', '2016-06-09'),
(3, 2, 40, 'iPhone', 8, 'Apple', 2, 'Eric Fargose', '101.00', 2, '202.00', '2016-06-09'),
(4, 2, 30, 'Canon EOS 5D', 9, 'Canon', 2, 'Eric Fargose', '100.00', 3, '300.00', '2016-06-09');
...
(32, 'Product 5', '', '', '', '', '', '', '', 999, 6, 'catalog/demo/ipod_touch_1.jpg', 0, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 17:07:26', '2011-09-30 01:07:22'),
...
(34, 'Product 7', '', '', '', '', '', '', '', 1000, 6, 'catalog/demo/ipod_shuffle_1.jpg', 0, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 18:07:54', '2011-09-30 01:07:17'),
...
(36, 'Product 9', '', '', '', '', '', '', '', 994, 6, 'catalog/demo/ipod_nano_1.jpg', 0, 0, '100.0000', 100, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-03 18:09:19', '2011-09-30 01:07:12'),
(40, 'product 11', '', '', '', '', '', '', '', 970, 5, 'catalog/demo/iphone_1.jpg', 0, 1, '101.0000', 0, 9, '2009-02-03', '10.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 21:07:12', '2011-09-30 01:06:53'),
(41, 'Product 14', '', '', '', '', '', '', '', 1077, 5, 'catalog/demo/imac_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 0, '2009-02-03 21:07:26', '2011-09-30 01:06:44'),
...
(48, 'product 20', 'test 1', '', '', '', '', '', 'test 2', 1000, 5, 'catalog/demo/ipod_classic_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-08', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 0, '2009-02-08 17:21:51', '2011-09-30 01:07:06'),
...
--
-- Table structure for table `oc_purchaseorder`
--

CREATE TABLE `oc_purchaseorder` (
  `id` int(11) NOT NULL,
  `product_name` varchar(255) NOT NULL,
  `product_id` int(11) NOT NULL,
  `manufacturer_name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `oc_purchaseorder`
--

INSERT INTO `oc_purchaseorder` (`id`, `product_name`, `product_id`, `manufacturer_name`, `manufacturer_id`, `tdate`, `price`, `quantity`, `po_number`) VALUES
(1, 'Product 8', 35, 'HTC', 5, '2016-06-08', '10.00', 5, 1),
(2, 'iPod Classic', 48, 'Palm', 6, '2016-06-08', '15.00', 10, 2),
(3, 'test name', 36, 'HTC', 5, '2016-06-08', '5.00', 10, 1),
(4, 'test name 2', 37, 'Palm', 6, '2016-06-08', '20.00', 10, 2),
(5, 'HTC Touch HD', 28, 'HTC', 5, '2016-06-09', '100.00', 0, 3),
(6, 'iMac', 41, 'Apple', 8, '2016-06-11', '100.00', 100, 4);
...
(314, 0, 'config', 'config_email', 'fargose.aaron@gmail.com', 0),
...
(316, 0, 'config', 'config_encryption', '', 0),
...
(315, 0, 'config', 'config_url', 'http://inventory.kp/', 0);
...
(1, 1, 'admin', 'a62fe2146024b351c5da1c11a6e81364f4ef0d1e', 'QQwDnwlTZ', 'Aaron', 'Fargose', 'fargose.aaron@gmail.com', '', '', '::1', 1, '2016-05-08 09:46:52');
...
--
-- Indexes for table `oc_inward`
--
ALTER TABLE `oc_inward`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `oc_outward`
--
ALTER TABLE `oc_outward`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `oc_purchaseorder`
--
ALTER TABLE `oc_purchaseorder`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `oc_inward`
--
ALTER TABLE `oc_inward`
...
--
-- AUTO_INCREMENT for table `oc_outward`
--
ALTER TABLE `oc_outward`
...
--
-- AUTO_INCREMENT for table `oc_purchaseorder`
--
ALTER TABLE `oc_purchaseorder`
