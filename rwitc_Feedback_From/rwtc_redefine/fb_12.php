...
if(isset($_GET['last_id'])){
	$action="test12.php?last_id=".$_GET['last_id']."&code=".$code;
} else{
	$action="test12.php";
}
...
<br><br>
<input type="radio" name="exp" value="Excellent"> Excellent <br>
<input type="radio" name="exp" value="Good"> Good<br>
<input type="radio" name="exp" value="Average"> Average<br>
<input type="radio" name="exp" value="Below Average"> Below Average<br>
<input type="radio" name="exp" value="Poor"> Poor<br>
