...
if(isset($_GET['last_id'])){
	$action="test8.php?last_id=".$_GET['last_id']."&code=".$code;
} else{
	$action="test8.php";
}
...
{
    if( $('input[name="rstroom"]:checked').length == 0 )
    {
...
8.	Rest Rooms
<br><br>
<input type="radio" name="rstroom" value="Excellent"> Excellent <br>
<input type="radio" name="rstroom" value="Good"> Good<br>
<input type="radio" name="rstroom" value="Average"> Average<br>
<input type="radio" name="rstroom" value="Below Average"> Below Average<br>
<input type="radio" name="rstroom" value="Poor"> Poor<br>
<input type="radio" name="rstroom" value="Not applicable"> Not applicable<br>
