...
if(isset($_GET['last_id'])){
	$action="test11.php?last_id=".$_GET['last_id']."&code=".$code;
} else{
	$action="test11.php";
}
...
11.	Billing Process (Prompt & Accuracy)
<br><br>
<input type="radio" name="bill" value="Excellent"> Excellent <br>
<input type="radio" name="bill" value="Good"> Good<br>
<input type="radio" name="bill" value="Average"> Average<br>
<input type="radio" name="bill" value="Below Average"> Below Average<br>
<input type="radio" name="bill" value="Poor"> Poor<br>
<input type="radio" name="bill" value="Not applicable"> Not applicable<br>
